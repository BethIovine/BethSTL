...
#ifndef BETHSTL_TREE_H
#define BETHSTL_TREE_H
...
protected:
    ...
    typedef simpleAlloc<_Rb_tree_node<_Tp>, _Alloc> _Alloc_type;
...
template<class _Key, class _Value, class _KeyOfValue, class _Compare,
        class _Alloc = STL_DEFAULT_ALLOCATOR>
